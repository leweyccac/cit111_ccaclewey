...
public class AircraftOperations {
        ...
        do{ 
            ...
            switch(response){
                ...
                case 8:
                    ...
                    }else if(mainPumpSwitchOn == false){
                        System.out.println("Somethings not right. Please "
                                + "consult the flight manual");
                        System.out.println("before trying again.");
                    }else if(wingPumpSwitchOn == false){
                        System.out.println("Somethings not right. Please "
                                + "consult the flight manual");
                        System.out.println("before trying again.");
                    }else if(wingPumpSwitchOn == false && mainPumpSwitchOn == false){
                        System.out.println("Somethings not right. Please "
                                + "consult the flight manual");
                        System.out.println("before trying again.");
                    }else{    
    ...
    public static void flightManualArray()throws InterruptedException{
            ...
            switch(response){
                ...
                case 5:
                    ...
                    System.out.println("however, it will cause a strain on "
                            + "the generator.");
                    System.out.println("The main fuel pump must be activated "
                ...
                case 6:
                    ...
                    System.out.println("however, it will cause a strain on "
                            + "the generator.");
                    System.out.println("The wing fuel pump must be activated "
                            + "prior to engine start.");
                    Thread.sleep(4000);
                    loopSwitchArray1 = false;                    
                break;
                ...
                case 7:
                    ...
                    System.out.println("the main fuel pumps, and wing fuel "
                            + "pumps must be on");
        ...
        } while(loopSwitchArray1 == true); // close do/while block     
    ...
    public static void extBattSwitchOn()throws InterruptedException{
        ...
        } while(loopSwitchExtBattOn == true); // close do/while block 
    ...
    public static void intBattSwitchOn()throws InterruptedException{
        ...
        } while(loopSwitchIntBattOn == true); // close do/while block    
    ...
    public static void inverterSwitchOn()throws InterruptedException{
        ...
        } while(loopSwitchInverterOn == true); // close do/while block
    ...
    public static void aPUSwitchOn()throws InterruptedException{        
        ...
        do{
            ...
            if(response2 == 1 && inverterSwitchOn == true && wingPumpSwitchOn 
                    == false && mainPumpSwitchOn == false){
    ...
    public static void mainFuelPumpSwitchOn()throws InterruptedException{
        ...
        } while(loopSwitchMainsOn == true); // close do/while block   
    ...
    public static void wingFuelPumpSwitchOn()throws InterruptedException{
        ...
        } while(loopSwitchWingsOn == true); // close do/while block    
    ...
    public static void landingGear()throws InterruptedException{
        ...
        }while(loopSwitchLG == true); // close do/while block   
