...
public class UnitConverter {
                ...
                switch (response){
                    ...
                    case 2:
                        ...
                        System.out.println("There are " + conversionGU + 
                                " Universes to requested Galaxies.");
                    ...
                    case 3: 
                        ...
                        System.out.println("There are " + conversionTP + " "
                                + "Taridigrades to requested pennies.");
                        ...
                        System.out.println("The volume measured for the "
                                + "Tardigrades is " + returnedTardigradesVol 
                                + " micrometers cubed.");
    ...
    /**
     * Method earthVol contains variables for volume and returns the equation 
     * once the method is called with 1 parameter.
     * @param r      
    ...
    /**
     * Method jupiterVol contains variables for volume and returns the equation 
     * once the method is called with 1 parameter.
     * @param r      
    ...
    /**
     * Method galaxyVol contains variables for volume and returns the equation 
     * once the method is called with 2 parameters.
     * @param r
     * @param h      
    ...
    /**
     * Method universeVol contains variables for volume and returns the equation 
     * once the method is called with 1 parameter.
     * @param r
    ...
    /**
     * Method tardigradesVol contains variables for volume and returns the 
     * equation once the method is called with 2 parameters.
     * @param r
     * @param h
    ...
    /**
     * Method pennyVol contains variables for volume and returns the equation 
     * once the method is called with 2 parameters.
     * @param r
     * @param h
